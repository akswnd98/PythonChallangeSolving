#find small letter surrounded by each 3 big letter
...
for x in str1:
    if x in smallLetter:
        if (str1[i - 1] in bigLetter) and (str1[i - 2] in bigLetter) and (str1[i - 3] in bigLetter) and (str1[i + 1] in bigLetter) and (str1[i + 2] in bigLetter) and (str1[i + 3] in bigLetter) and (str1[i - 4] not in bigLetter) and (str1[i + 4] not in bigLetter):
            str2 = str2 + x
